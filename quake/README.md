...
The browser-facing WASM, game archive, and custom PAK are split into sub-700 KB pieces for dependable GitHub delivery. `sw.js` reassembles those files transparently inside the browser.
